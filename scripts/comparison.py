...
def run_comparison(*, model: str, dandiset_id: str, subfolder1_name: str, subfolder2_name: str) -> Dict[str, Any]:
    notebook1_path = get_notebook_path(dandiset_id=dandiset_id, subfolder_name=subfolder1_name)
    notebook2_path = get_notebook_path(dandiset_id=dandiset_id, subfolder_name=subfolder2_name)
