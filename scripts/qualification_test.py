...
dandi_ai_notebooks_3_dir = os.environ.get("DANDI_AI_NOTEBOOKS_3_DIR")
if dandi_ai_notebooks_3_dir is None:
    raise ValueError("DANDI_AI_NOTEBOOKS_3_DIR environment variable is not set.")

def get_notebook_path(*, dandiset_id: str, subfolder_name: str) -> str | None:
    p = f'{dandi_ai_notebooks_3_dir}/dandisets/{dandiset_id}/{subfolder_name}/{dandiset_id}.ipynb'
...
def run_qualification_test(*, model: str, dandiset_id: str, subfolder_name: str):
    notebook_path = get_notebook_path(dandiset_id=dandiset_id, subfolder_name=subfolder_name)
...
def main():
    ...
    test_result_path = f'{this_dir}/../reviews/{model_second_part}/dandisets/{dandiset_id}/{subfolder_name}/qualification_test.json'
    ...
    if os.path.exists(test_result_path):
        ...
        result = run_qualification_test(model=model, dandiset_id=dandiset_id, subfolder_name=subfolder_name)
